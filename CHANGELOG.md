# Changelog - Stary człowiek i morze (SCIM)

Najnowsze wersje na górze. Źródło prawdy w grze: `scripts/globals/changelog_data.gd`
(ekran "Historia zmian" w menu czyta z tego pliku). Aktualizując grę, dodaj wpis
na górze tam ORAZ tutaj.
